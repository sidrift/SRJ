...
public class SilverJewelryCalculationService : ISilverJewelryCalculationService
{
    ...
    public async Task<SilverPriceCalculationResponse> CalculateAsync(
        string sku)
    {
        ...
        var totalAmount = Math.Round(item.WeightInGrams * finalRatePerGram, 2);
